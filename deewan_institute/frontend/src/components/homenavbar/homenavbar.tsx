...
const createOverlayColumns = (t: ReturnType<typeof useTranslation>["t"]) => [
  {
    id: "arabic",
    title: t("components.homenavbar.homenavbar.title_arabic_language_and_culture"),
    links: [
      { label: t("pages.arabiccourses.arabicCourses.title_arabic_courses"), to: "/arabic-courses" },
      { label: t("components.homenavbar.homenavbar.label_arabic_calculator_price"), to: "/calculator" },
      {
        label: (
          <>
      ...
      { label: t("components.homenavbar.homenavbar.label_culture_events"), to: "https://deewantourism.com/cultureevents" },
    ],
  },
  {
    id: "middle-east",
  ...
  },
  {
    ...
    title: t("components.homenavbar.homenavbar.title_learning_resources"),
    links: [
      ...
      { label: t("pages.podcasts.fusha.title_podcasts_fusha"), to: "/podcasts-fusha" },
      { label: t("pages.audiobooks.navbar.audio_books"), to:"/audiobooks"},
      { label: t("pages.bookshop.bookshop.title_bookshop"), to: "https://deewanbookshop.com" }

    ],
  },
  {
    id: "Student Services",
    title: t("components.homenavbar.homenavbar.title_student_services"),
    links: [
      { label: t("components.homenavbar.homenavbar.label_accommodation"), to: "https://deewantourism.com/accommodation" },
      { label: t("components.homenavbar.homenavbar.label_trips"), to: "https://deewantourism.com/trips" },
      { label: t("components.homenavbar.homenavbar.label_visa"), to: "https://deewantourism.com/visa" },
    ],
  },
  {
    id: "languages",
    title: t("components.homenavbar.homenavbar.title_foreign_languages"),
    links: [
      { label: t("components.homenavbar.homenavbar.label_french"), to: "/foreign-languages/french-course" },
      { label: t("components.homenavbar.homenavbar.label_german"), to: "/foreign-languages/german-course" },
      { label: t("components.homenavbar.homenavbar.label_spanish"), to: "/foreign-languages/spanish-course" },
      { label: t("components.homenavbar.homenavbar.label_english"), to: "/foreign-languages/english-course" },
    ],
  },
  {
    id: "team",
    title: t("components.homenavbar.homenavbar.title_join_our_team"),
    links: [
